...
function onConnection(socket) {
  ...
  const synteticSocket = new Socket(socket, redbone);
  socket.on(redbone.eventIn, (action) => dispatcher(synteticSocket, action));
...
redbone.dispatch = function dispatch(action) {
  ...
  Socket.dispatch(redbone.io, action, redbone.eventOut);
}
...
redbone.dispatchTo = function dispatchTo(socket_id, action) {
  ...
  Socket.dispatch(socket, action, redbone.eventOut);
}
...
redbone.eventIn = 'dispatch';
redbone.eventOut = 'dispatch';
